...
library("MADSEQ")
# load the sample data aneuploidyChrom, the data set includes the dataframe for heterozygous sites
# read depth for each site and average depth for the whole genome
