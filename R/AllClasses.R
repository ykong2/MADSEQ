...
#' function
#' @slot posterior A \code{matrix} contains the posterior distribution from the
#' selected model
...
#' \code{deltaBIC(x)}: Get the deltaBIC between selected model and other models}
#' @section Summary:
#' \describe{In the code below, \code{x} is a \code{MadSeq} object. \cr\cr
