...
#' meiotic trisomy, loss of heterozygosity). The package also includes function
#' to visualize the estimated distribution for detected mosaic aneuploidy. 
#' To fully understand how to use the MADSEQ package, please refer to the 
#' documentation. The manual explains what data do you need, and how to process
#' the data to be ready for the model, what steps to follow and how to interpret 
